  ...
  return (
    <div className="min-h-screen bg-[#080d18]">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-10">
        ...
        {/* ─── Zone d'action : cartes de même taille (hauteur égale), couleur = importance ── */}
        <div className={hasRightCol ? "grid lg:grid-cols-2 gap-6 mb-6" : "mb-6"}>

        {/* À FAIRE (héros, couleur ambre = action prioritaire) */}
        <div className={`h-full rounded-2xl p-4 border ${totalTaches > 0 ? "bg-amber-500/[0.06] border-amber-500/20" : "bg-emerald-500/[0.05] border-emerald-500/20"}`}>
        ...
        {relances.length > 0 && (
          <div className="bg-slate-800/40 border border-amber-500/20 rounded-2xl overflow-hidden h-full">
