    ...
    <>
      ...
      {!open && (
        <button
          ...
          className="fixed bottom-5 right-5 z-40 w-12 h-12 bg-violet-600 hover:bg-violet-500 text-white rounded-full shadow-lg flex items-center justify-center transition-all hover:scale-105"
      ...
      {open && (
        <div
          className={`fixed bottom-5 right-5 z-50 w-80 sm:w-96 bg-slate-900 border border-white/10 rounded-2xl shadow-2xl flex flex-col transition-all ${
