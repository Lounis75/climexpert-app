...
export default function CommercialLoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(true);
    try {
      await fetch("/api/commercial/login", {
        method:  "POST",
      ...
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-xl p-8">
        <div className="flex items-center gap-2 mb-8">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">Espace commercial</p>
          </div>
        </div>
          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                ...
                className="w-full py-3 bg-violet-500 hover:bg-violet-400 disabled:opacity-50 text-white font-semibold rounded-xl transition-colors"
              >
