...
export const metadata: Metadata = {
  title: "Tarifs Climatisation Île-de-France 2025 — Prix Installation & Entretien",
  description:
  ...
  openGraph: {
    title: "Tarifs Climatisation Île-de-France 2025 — ClimExpert",
