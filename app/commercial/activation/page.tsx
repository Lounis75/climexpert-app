  ...
  useEffect(() => {
    ...
    fetch("/api/commercial/verify", {
      ...
      .then((data) => {
        if (data.ok) {
          setStatus("success");
          setTimeout(() => router.replace("/commercial/dashboard"), 1500);
        } else {
          setStatus("error");
      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-sm text-center">
        ...
        {status === "error" && (
          <>
            ...
            <a href="/commercial/login" className="text-violet-500 text-sm font-medium">
...
export default function CommercialActivationPage() {
  return <Suspense><ActivationContent /></Suspense>;
}
